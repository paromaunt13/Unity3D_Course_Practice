...
public class PoisonBoss : MonoBehaviour, IEnemy
{
    ...
    private float _attackPower = 200f;
    ...
    private IEnumerator Attacking()
    {
        if (_allowToAttack)
        {
            ...
            PoisonBossProjectile poisonBossProjectile = projectile.GetComponent<PoisonBossProjectile>();

            poisonBossProjectile.SetDamage(Damage);
